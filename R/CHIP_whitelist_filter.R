...
gList<-fread("CHIP_Rules.tsv")
whitelist.mis<-fread("CHIP_missense_vars.tsv")
whitelist.splice<-fread("CHIP_splice_vars.tsv")
whitelist.LoF<-fread("CHIP_nonsense_FS_vars.tsv")
